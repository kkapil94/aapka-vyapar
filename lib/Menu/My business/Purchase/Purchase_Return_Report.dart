...
class Purchase_Return_Report extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Purchase_Return_Report();
}

class _Purchase_Return_Report extends State<Purchase_Return_Report> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Purchase Return', style: TextStyle(color: Colors.black)),
      ),
      body: Container(
        color: Colors.white,
        child: Stack(
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text("No of Txns",style: TextStyle(fontSize: 10),),
                                    Text("4",style: TextStyle(color: Colors.black,fontSize: 12),),
                                  ],
                                ),
                              ),
                            ),
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text("Total Purchase Return",style: TextStyle(fontSize: 10),),
                                    Text("₹ 150.00",style: TextStyle(fontSize: 12),),
                                  ],
                                ),
                              ),
                            ),
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text("Balance Due",style: TextStyle(fontSize: 10),),
                                    Text(
                                      "₹ 4750",
                                      style: TextStyle(color: Color(0xFF38C782),fontSize: 12),
                                    ),
                                  ],
                                ),
                              ),
            ...
            Positioned(
              ...
              child: Center(
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Purchase_Return()));
                  },
                  child:Row(
                    mainAxisSize: MainAxisSize.min,
