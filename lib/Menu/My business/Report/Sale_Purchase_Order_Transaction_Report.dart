...
class Sale_Purchase_Order_Transaction_Report extends StatefulWidget {
  Sale_Purchase_Order_Transaction_Report({super.key});

  @override
  State<Sale_Purchase_Order_Transaction_Report> createState() => _Sale_Purchase_Order_Transaction_Report();
}

class _Sale_Purchase_Order_Transaction_Report extends State<Sale_Purchase_Order_Transaction_Report> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Order Transaction Report",style: TextStyle(color: Colors.white),),
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
                children:[
                  Text("Transaction",style: TextStyle(color: Colors.black54,fontSize: 16),),
              ]
            ),
          ),
          Expanded(
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                           Text("11 Mar", style: TextStyle(fontSize: 13)),
