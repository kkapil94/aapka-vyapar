...
class Stock_Detail_Report extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Stock_Detail_Report();
}

class _Stock_Detail_Report extends State<Stock_Detail_Report> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Stock Details Report', style: TextStyle(color: Colors.black)),
        actions: [
          Container(
            height: 25,
            width: 25,
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: TextButton(
                                      ...
                                      onPressed: (){},
                                      child: Center(child: Text("Txns Type - Sales & Cr.Note",style: TextStyle(fontSize: 11,color: Colors.black),))
                                  ),
                                ),
                                SizedBox(width: 10,),
                                SizedBox(
                          ...
                          return Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text("Closing Quantity : ",style: TextStyle(color: Colors.grey),),
                                    Text("50.00"),
                                  ],
                                ),
                                SizedBox(height: 5,),
