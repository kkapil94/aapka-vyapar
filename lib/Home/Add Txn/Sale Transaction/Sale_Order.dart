  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Sale Order', style: TextStyle(color: Colors.black)), // Sets text color
        actions: [
          IconButton(
            icon: Icon(Icons.settings, color: Colors.black), // Ensures icon color is visible
            onPressed: () {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      OutlinedButton(
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (builder)=>Add_Items_to_Sale(title: "Add Items to Sale Order")));
                        },
