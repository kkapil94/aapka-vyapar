...
class AddNewSales extends State<Add_new_Sales> {
  ...
  TextEditingController received_amount_controller = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Sale',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: type=="Credit"?Colors.green:Color(0xFFE8E8E8),
                      ),
                      child: Row(
                          children: [
                               SizedBox(width: 5,),
                               Text("Credit",style: TextStyle(color: type=="Credit"?Colors.white:Colors.black),),
                          ]
                      ),
                    ),
                  ),
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(15),
                        color: type=="Cash"?Colors.green:Color(0xFFE8E8E8),
                      ),
                      child: Row(
                        children: [
                          SizedBox(width: 5,),
                          Text("Cash",style: TextStyle(color: type=="Cash"?Colors.white:Colors.black),),
                        ],
                      ),
                    ),
                  ),
                              ...
                              Expanded(
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    // TextField
                                    TextField(
                                      controller: received_amount_controller,
                                      focusNode: received_focusnode,
                                      onChanged: (value) {
                                        setState(() {
                                          received_amount_controller.text = value;
                                        });
                                      },
                                      keyboardType: TextInputType.number,
                                      textAlign: TextAlign.end,
