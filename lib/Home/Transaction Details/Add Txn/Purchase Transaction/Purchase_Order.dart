...
class Purchase_Order extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PurchaseOrder();
}

class PurchaseOrder extends State<Purchase_Order> {
  ...
  void initState() {
    ...
    due_date_focusnode.addListener((){
      setState(() {
        is_due_date_focused = due_date_focusnode.hasFocus;
      });
    });
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  floatingLabelStyle: TextStyle(color: is_due_date_focused?Colors.blueAccent:Colors.grey),
                                  labelText: "Due Date",
